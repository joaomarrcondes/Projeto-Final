            ...
            <section class="container">
                <form name="formcadastro" action="cadastro">
                    <div class="mb-3">
                        ...
                        <input name="usuario" class="form-control" type="text" id="inputNome">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="telefone" class="form-control" id="inputTelefone" type="tel" onkeyup="handlePhone(event)" maxlength="15">
                    </div>
                    <div class="mb-3">
                        <label for="inputData" class="form-label">Data Nascimento</label>
                        <input name="data" class="form-control" id="inputData" type="date">
                    </div>
                    <div class="mb-3">
                        <label for="inputCpf" class="form-label">Cpf</label>
                        <input name="cpf" class="form-control" id="inputCpf" type="text" onkeyup="handleCpf(event)" maxlength="14">
                    </div>
